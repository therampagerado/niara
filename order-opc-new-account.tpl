    ...
    <fieldset>
      <div class="box">
        ...
        <div id="opc_account_form" class="unvisible">
          ...
          <input type="hidden" id="opc_id_address_invoice" name="opc_id_address_invoice" value="{if isset($guestInformations) && isset($guestInformations.id_address_invoice) && $guestInformations.id_address_invoice}{$guestInformations.id_address_invoice}{else}{if isset($guestInformations) && isset($guestInformations.id_address_delivery) && $guestInformations.id_address_delivery}{$guestInformations.id_address_delivery}{else}0{/if}{/if}">
